...
foreach($result as $row) {
	$array[]=array(
		'no'=>$no++,
		'waktu'=>$row["waktu"],
		'gambar'=>'<img src="img/'.$row["gambar"].'" width="150"/>',
		'judul'=>$row["judul"],
		'deskripsi'=>excerpt($row["deskripsi"],150),
		'link'=>$row["link"],
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">                 
			<div class="card mb-3">
				<div class="card-header text-center bg-dark text-white">Halaman Pengaturan Blog</div>
                <div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<a href="tambah.php" class="btn btn-dark btn-block"><i class="fa fa-plus"></i> Tambah Tulisan</a>
						</div>
						<!--
						<div class="col-md-6">
